...
"""Verify that starting fuducoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fuducoin with -h for help text")
        ...
        self.log.info("Start fuducoin with -version for version information")
        ...
        self.log.info("Start fuducoind with -fakearg to make sure it does not start")
