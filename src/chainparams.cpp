...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.fuducoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.fuducointools.com");
        vSeeds.emplace_back("dnsseed.fuducoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.fuducointools.com");
        vSeeds.emplace_back("seed-b.fuducoin.loshan.co.uk");
