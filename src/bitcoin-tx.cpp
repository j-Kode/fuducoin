...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fuducoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fuducoin-tx [options] <hex-tx> [commands]  Update hex-encoded fuducoin transaction\n" +
            "or:     fuducoin-tx [options] -create [commands]   Create hex-encoded fuducoin transaction\n" +
            "\n";
