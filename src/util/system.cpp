...
const char * const BITCOIN_CONF_FILENAME = "fuducoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Fuducoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Fuducoin";
#else
    // Unix
    return pathRet / ".fuducoin";
#endif
#endif
}
