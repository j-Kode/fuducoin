# Support for Output Descriptors in Fuducoin Core

Since Fuducoin Core v0.17, there is support for Output Descriptors. This is a
...
on Fuducoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Fuducoin Core wallets, a convenience function `combo` is
