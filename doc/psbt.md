# PSBT Howto for Fuducoin Core

Since Fuducoin Core 0.17, an RPC interface exists for Partially Signed Fuducoin
...
PSBT is an interchange format for Fuducoin transactions that are not fully signed
...
#### Multisig with multiple Fuducoin Core instances
