...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 icks per kB (0.00001 FUDU). This is to prepare for dropping the minimum transaction fee to 0.1 icks per kB (0.0001 FUDU) in the next release.
